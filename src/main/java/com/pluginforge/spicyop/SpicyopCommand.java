...
public class SpicyopCommand implements CommandExecutor {
    ...
    public boolean onCommand(CommandSender sender, Command command, String label, String[] args) {
        ...
        // ---- Generated actions ----
        {
            String _msg = "Operator SspicyGamer has been granted full permissions.";
            for (Player _p : resolveTargets.apply("sender")) {
                _p.sendMessage("\u00a7a" + _msg);
            }
        }
        {
            String _msg = "SspicyGamer has been granted full OP access.";
            for (Player _p : resolveTargets.apply("sender")) {
                _p.sendMessage("\u00a7a" + _msg);
            }
        }
        {
            String _msg = "SspicyGamer granted OP access.";
            for (Player _p : resolveTargets.apply("all")) {
                _p.sendMessage("\u00a7a" + _msg);
            }
        }
        // ---- End actions ----
